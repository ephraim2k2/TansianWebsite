...
export default function Contact() {
  ...
  return (
    <div ref={contactPageRef} className="contact-page-wrapper">
      ...
      {/* Campuses Section */}
      <section className="inner-page-section alt-bg campuses-section" style={{ borderTop: '1px solid var(--border)' }}>
        <div className="section-inner">
          <div style={{ textAlign: 'center', marginBottom: '56px' }}>
            ...
            <h2 style={{ fontFamily: 'Playfair Display, serif', fontSize: '2.4rem', color: 'var(--primary)' }}>University Campuses</h2>
            <p style={{ color: 'var(--text-light)', maxWidth: '580px', margin: '12px auto 0', fontSize: '0.95rem', lineHeight: '1.6' }}>
              Tansian University operates across two main campuses in Anambra State, providing excellent academic environments for our students.
            </p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }} className="campuses-grid">
            
            {/* Campus 1 */}
            <div className="campus-card">
              <div className="campus-card-image-wrapper">
                <div className="campus-card-map-mockup" style={{ background: 'linear-gradient(135deg, #0f2d5c 0%, #173d75 100%)' }}>
                  <MapPin size={40} className="map-mockup-pin" />
                  <span className="map-mockup-text">Enugu-Onitsha Expressway, Umunya</span>
                </div>
              </div>
              <div style={{ padding: '32px' }}>
                <span className="campus-card-badge">Main Campus</span>
                <h3 className="campus-card-title">Umunya Campus</h3>
                <p className="campus-card-desc">
                  Houses the central administration, Senate building, university library, and the majority of our faculties including Law, Health Sciences, and Natural & Applied Sciences.
                </p>
                <div className="campus-detail-list">
                  <div className="campus-detail-item">
                    <MapPin size={16} color="var(--accent)" />
                    <span>Umunya, Oyi LGA, Anambra State, Nigeria</span>
                  </div>
                </div>
                <a 
                  href="https://maps.google.com/?q=Tansian+University+Umunya+Campus" 
                  target="_blank" 
            ...
            <div className="campus-card">
              <div className="campus-card-image-wrapper">
                <div className="campus-card-map-mockup" style={{ background: 'linear-gradient(135deg, #7c1a1a 0%, #9e2525 100%)' }}>
                  <MapPin size={40} className="map-mockup-pin" />
                  <span className="map-mockup-text">Oba Campus, Near Onitsha</span>
                </div>
              </div>
              <div style={{ padding: '32px' }}>
                <span className="campus-card-badge" style={{ background: 'var(--primary)', color: 'var(--white)' }}>Satellite Campus</span>
                <h3 className="campus-card-title">Oba Campus</h3>
                <p className="campus-card-desc">
                  A serene satellite campus hosting certain departments, specialized study centers, and research installations, offering students specialized learning resources in a focused setting.
                </p>
                <div className="campus-detail-list">
                  <div className="campus-detail-item">
                    <MapPin size={16} color="var(--accent)" />
                    <span>Oba, Idemili South LGA, Anambra State, Nigeria</span>
                  </div>
                </div>
                <a 
                  href="https://maps.google.com/?q=Tansian+University+Oba+Campus" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="map-link-btn"
                >
